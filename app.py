...
def plot_volcano_plot(matrix_df):
    """Crée un volcano plot pour comparer deux groupes d'individus"""
    ...
    with col1:
        ...
        st.session_state.volcano_pvalue_threshold = p_threshold
    ...
    with col2:
        ...
        st.session_state.volcano_fc_threshold = fc_threshold
